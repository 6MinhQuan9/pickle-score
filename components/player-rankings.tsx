...
export function PlayerRankings({ players, onPlayerSelect, selectedPlayer }: PlayerRankingsProps) {
  return (
      ...
      <table className="w-full">
        <thead className="sticky top-0 bg-background z-10">
          <tr className="text-left">
            ...
            <th className="w-[100px] px-2 py-2 text-sm font-semibold text-right">Matches</th>
            <th className="w-[100px] px-2 py-2 text-sm font-semibold text-right">Win Rate</th>
            <th className="w-[140px] px-2 py-2 text-sm font-semibold text-right">Last 5</th>
          </tr>
        </thead>
        <tbody>
          {players.map((player) => (
            ...
            >
              <td className="w-12 px-2 py-2 text-center font-bold text-sm">{player.rank}</td>
